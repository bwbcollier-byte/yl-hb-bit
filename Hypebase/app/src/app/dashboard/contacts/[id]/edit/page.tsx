          ...
          <div className="max-w-4xl mx-auto pb-20">
            ...
            <div className="bg-[var(--color-brand-surface-1)] border border-white/5 rounded-2xl overflow-hidden shadow-2xl">
              <div className="p-8 border-b border-white/5 bg-gradient-to-r from-[var(--color-brand-surface-2)]/50 to-transparent flex items-center justify-between">
                <div>
                  <h1 className="text-2xl font-bold font-heading mb-1">Edit Contact</h1>
                  <p className="text-[var(--color-brand-muted)] text-sm">Update personal info, company associations, and notes.</p>
                </div>
                {contactData?.avatar_url && (
                   <div className="w-16 h-16 rounded-xl border border-white/10 overflow-hidden shadow-xl">
                      <img src={contactData.avatar_url} alt={contactData.name_full} className="w-full h-full object-cover" />
                   </div>
                )}
              </div>
              ...
              <div className="p-8">
                {error ? (
                  ...
                  <ContactForm initialData={contactData} id={id as string} />
                )}
              </div>
            </div>
          </div>
