      ...
      <div className="flex-1 flex flex-col h-full overflow-hidden relative z-10 w-full">
        ...
        <div className="flex-1 overflow-y-auto no-scrollbar p-8 pb-32">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="mb-12">
              <h1 className="text-4xl font-heading font-extrabold text-white tracking-tight mb-2">Add New Venue</h1>
              <p className="text-[var(--color-brand-muted)] font-medium">Create a new stadium, arena, or multi-purpose venue profile.</p>
            </div>
